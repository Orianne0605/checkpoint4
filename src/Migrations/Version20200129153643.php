 ...
 */
final class Version20200129153643 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1F93C1978 FOREIGN KEY (teaches_id) REFERENCES teaches (id)');
